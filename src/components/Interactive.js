...
function Interactive({ title }) {
    ...
    useEffect(() => {
      ...
      setViewBox(`-300 -80 ${width} ${height}`);
    }, []);
        ...
        case "fent":
            return (
                <div className="fill-width" id="fent-bg">
                    <button onClick={handleOx}>OXYCODONE</button>
                    <button onClick={handleHer}>HEROIN</button>
                    <button onClick={handleFen}>FENTANYL</button>
                    
<svg ref={svgRef} id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox={viewBox}>
